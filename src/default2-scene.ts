import { Material, Mesh, MeshBasicMaterial, Scene, SphereGeometry, SpotLight, TorusGeometry, Vector3, type PerspectiveCamera, type WebGLRenderer } from "three";
...
export class Default2Scene implements ExampleScene {
